...
- **Quantum Computing:** Qiskit, QASM 2.0/3.0, QAOA, VQE, Grover, Shor, Deutsch-Jozsa, QFT algorithms; real-hardware execution on IBM Quantum; active contributor to IBM's Qiskit Runtime and qiskit-addon-sqd (Sample-based Quantum Diagonalization); Agent Stack Canvas for circuit and topology visualization; building hybrid quantum-classical multi-agent systems
...
<div align="center">
<sub>ℹ️ Profile information collected and updated by AI assistant on September 18, 2026</sub>
</div>
